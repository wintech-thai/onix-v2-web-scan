...
export interface Translations {
  ...
  registration: {
    ...
    registrationSuccessLine1: string;
    emailLabel: string;
    otpLabel: string;
...
export const translations: Record<Language, Translations> = {
  th: {
    ...
    messages: {
      ...
      PARAM_MISSING: [
        "ข้อมูลที่จำเป็นสำหรับการตรวจสอบไม่ครบถ้วน ไม่สามารถดำเนินการตรวจสอบความแท้ได้",
      ],
      PARAMETER_MISSING: [
      ...
      NO_DATA: [
        "ไม่มีข้อมูลสำหรับการตรวจสอบ ลิงก์หรือ QR Code อาจไม่ถูกต้อง หรือข้อมูลเสียหาย",
      ],
      MISSING_THEME: ["ไม่มีข้อมูล theme ในลิงก์"],
      MISSING_ORG: ["ไม่มีข้อมูล org ในลิงก์"],
      DECRYPT_FAIL: [
        "ไม่สามารถอ่านข้อมูลสินค้าได้ ข้อมูลอาจเสียหายหรือไม่ถูกต้อง",
      ],
      DECRYPT_ERROR: [
        "ไม่สามารถอ่านข้อมูลสินค้าได้ ข้อมูลอาจเสียหายหรือไม่ถูกต้อง",
      ],
      INVALID: [
        "ข้อมูลสินค้าไม่ถูกต้องหรือไม่ตรงกับระบบ อาจเป็นสินค้าปลอมหรือข้อมูลถูกดัดแปลง",
      ],
      FAILED: [
        "การตรวจสอบความแท้ล้มเหลว เกิดข้อผิดพลาดจากระบบ กรุณาลองใหม่อีกครั้งหรือติดต่อทีมงาน",
      ],
    ...
    registration: {
      button: "ลงทะเบียนด้วยอีเมลล์",
      alreadyRegisteredLine1: "รายการนี้ถูกลงทะเบียนแล้วด้วยอีเมลล์",
      alreadyRegisteredLine2: "", // Will be populated with actual email
  ...
  en: {
    ...
    messages: {
      ...
      NOTFOUND: [
        "This product was not found in the system. It may not be registered",
      ],
      PARAM_MISSING: [
        "Required verification data is incomplete. Cannot proceed with authenticity verification",
      ],
      PARAMETER_MISSING: [
      ...
      NO_DATA: [
        "No verification data available. The link or QR Code may be invalid or corrupted",
      ],
      MISSING_THEME: ["Theme information is missing from the link"],
      MISSING_ORG: ["Organization information is missing from the link"],
      DECRYPT_FAIL: [
        "Cannot read product data. Data may be corrupted or invalid",
      ],
      DECRYPT_ERROR: [
        "Cannot read product data. Data may be corrupted or invalid",
      ],
      INVALID: [
        "Product data is invalid or does not match the system. May be counterfeit or tampered",
      ],
      FAILED: [
        "Authenticity verification failed. System error occurred. Please try again or contact support",
      ],
      EXPIRED: [
    ...
    registration: {
      button: "Registration",
      alreadyRegisteredLine1: "This item is already registered with email",
      alreadyRegisteredLine2: "", // Will be populated with actual email
